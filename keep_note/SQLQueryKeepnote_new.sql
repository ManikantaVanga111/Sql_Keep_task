create database keepnote_1_new1
use keepnote_1_new1
...
category_creator int references User1(User1_id)
)
...
reminder_creator int references User1(User1_id)
)
...
select * from note where note_creationdate='01/31/2019'
...
select * from category
select * from note
select * from category where category_creator=(select user1_id from note where note_id=1)
